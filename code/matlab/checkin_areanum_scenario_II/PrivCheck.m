...
pgy_input = csvread('../../python/checkin_areanum_scenario_II/tmp/pgy_check_in_privcheck.csv');
load('../../python/checkin_areanum_scenario_II/tmp/JSDM_girdGroup_privcheck')
