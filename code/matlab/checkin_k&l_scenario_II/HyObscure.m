...
pgy_input = csvread(strcat('../../python/checkin_k&l_scenario_II/tmp/pgy_check_in_',num2str(gg),'.csv'));
JSD_Mat_input = csvread(strcat('../../python/checkin_k&l_scenario_II/tmp/JSDM_check_in_',num2str(gg),'.csv'));
size(pgy_input)
size(JSD_Mat_input)
