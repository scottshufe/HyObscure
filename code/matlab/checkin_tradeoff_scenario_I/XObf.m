...
pgy_input = csvread(strcat('../../python/checkin_tradeoff_scenario_I/tmp/pgy_check_in_',num2str(gg),'_XObf.csv'));
JSD_Mat_input = csvread(strcat('../../python/checkin_tradeoff_scenario_I/tmp/JSDM_check_in_',num2str(gg),'_XObf.csv'));
size(pgy_input)
size(JSD_Mat_input)
