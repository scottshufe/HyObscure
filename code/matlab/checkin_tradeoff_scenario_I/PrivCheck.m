...
pgy_input = csvread('../../python/checkin_tradeoff_scenario_I/tmp/pgy_check_in_privcheck.csv');
load('../../python/checkin_tradeoff_scenario_I/tmp/JSDM_girdGroup_privcheck')
