...
function [FX, DB] = XObf(deltaX)
%function X = ageGroupPrivacyObf()
pgy_input = csvread('../../python/age_tradeoff_scenario_II/tmp/pgy_ageGroup_xobf.csv');
JSD_Mat_input = csvread('../../python/age_tradeoff_scenario_II/tmp/JSDM_ageGroup_xobf.csv');
size(pgy_input)
size(JSD_Mat_input)
