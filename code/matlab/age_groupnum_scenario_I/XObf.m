...
pgy_input = csvread('../../python/age_groupnum_scenario_I/tmp/pgy_ageGroup_XObf.csv');
JSD_Mat_input = csvread('../../python/age_groupnum_scenario_I/tmp/JSDM_ageGroup_XObf.csv');
size(pgy_input)
size(JSD_Mat_input)
