...
pgy_input = csvread(strcat('../../python/checkin_clusternum_scenario_II/tmp/pgy_check_in_',num2str(gg),'_HyObscure.csv'));
JSD_Mat_input = csvread(strcat('../../python/checkin_clusternum_scenario_II/tmp/JSDM_check_in_',num2str(gg),'_HyObscure.csv'));
size(pgy_input)
size(JSD_Mat_input)
