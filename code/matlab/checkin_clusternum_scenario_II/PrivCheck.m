...
pgy_input = csvread('../../python/checkin_clusternum_scenario_II/tmp/pgy_check_in_privcheck.csv');
load('../../python/checkin_clusternum_scenario_II/tmp/JSDM_girdGroup_privcheck')
